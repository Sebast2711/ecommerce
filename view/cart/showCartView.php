                        ...
                        <td>
                            <div class="quantity">
                                ...
                                <select name="quantity" id="quantity">
                                    ...
                                    <?php for ($i = 0; $i < $product['product']['quantity']+1; $i++ ) {
...
<div class ="buttons container text-center">
    ...
    <a href="index.php?action=orderCart"><button class="btn btn-block btn-buyProduct">Commander <i class="fas fa-shopping-cart"></i></button></a>                                    
